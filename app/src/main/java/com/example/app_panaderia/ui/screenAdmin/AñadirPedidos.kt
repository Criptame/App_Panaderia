...
fun AñadirPedidos(
    ...
    ModalNavigationDrawer(
        ...
        drawerContent = {
            ModalDrawerSheet {
                ...
                NavigationDrawerItem(
                    label = { Text(text = "Ir a Vizualisar") },
                    selected = false,
                    onClick = {
                        scope.launch { drawerState.close() }
                        viewModel.navigateTo(Screen.Vizu)
                    }
                )
            }
        }
        ...
        Scaffold(
            topBar = {
                TopAppBar(
                    title = { Text(text = "Añadir Pedidos") },
                    navigationIcon = {
                        IconButton(onClick = {
            ...
            // Contenido de la pantalla Añadir Pedidos
            Box(
                modifier = Modifier
                    .fillMaxSize()
                ...
                Text(text = "Aquí va el contenido para añadir pedidos.")
            }
        }
    }
}